...
// We discovered that the dinosaurs uses this exact method during the Mesozoic Era
...
#define log( format, ... ) DbgPrintEx( DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "[ 69 ] " format "\n", ##__VA_ARGS__ )
